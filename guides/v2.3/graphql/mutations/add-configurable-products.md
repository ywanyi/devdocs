...
`parent_sku` | String | The SKU of the parent product
...
`value_string` | String! | The value of the customizable option. For example, if color was the customizable option, a possible value could be `black`
